#!/usr/bin/env python3
"""Run P211 YOLO detector as sliced inference on the exact P206g/P101 pages."""
...
PREDICTIONS = ROOT / "reports/vlm/symbol_p211_20k_yolov8s_p206g_pages_sliced_predictions.jsonl"
REPORT = ROOT / "reports/vlm/symbol_p211_20k_yolov8s_p206g_pages_sliced_eval.json"
...
def main() -> None:
    ...
    parser.add_argument("--score-threshold-grid", default="0.001,0.003,0.005,0.01,0.02,0.05,0.1")
    ...
    report = {
        "id":"P212_p211_sliced_on_p206g_pages",
        "claim_boundary":"P211 detector run as raster sliced inference on exact P206g/P101 pages; selected thresholds are planning evidence only.",
