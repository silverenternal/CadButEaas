#!/usr/bin/env python3
"""Train/evaluate a raster+anchor proposal head on P0-42 blob anchors."""
...
def main() -> None:
    ...
    parser.add_argument("--report", default="reports/vlm/symbol_blob_anchor_head_p042_eval.json")
    ...
    report = {
        "version": "symbol_blob_anchor_head_p042_baseline",
        ...
        "feature_contract": {
            ...
            "metric_mode": "blob-anchor-level dataset diagnostic; not page-level final quality",
        },
