#!/usr/bin/env python3
"""Train/evaluate P228 merged-stair object specialist YOLO detector."""
...
DATA = ROOT / "datasets/symbol_p228_merged_stair_yolo/data.yaml"
OUT = ROOT / "checkpoints/symbol_p228_merged_stair_yolo"
REPORT = ROOT / "reports/vlm/symbol_p228_merged_stair_train_eval.json"
...
def main() -> None:
    ...
    report = {
        "id": "P228_merged_stair_train_eval",
        "claim_boundary": "Merged-stair object YOLO internal-probe metric only; must map/fuse back to original stair evaluation before promotion.",
        "data": rel(data_path),
        "weights": rel(weights),
        "config": vars(args),
        "tile_eval": eval_report,
        "next_required": "Run P228 page inference and evaluate merged-object recall plus original-target fusion impact.",
    }
