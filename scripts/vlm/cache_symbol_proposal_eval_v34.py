#!/usr/bin/env python3
"""Build v34 union proposal cache with the new tiny detector source."""
...
def main() -> None:
    ...
    parser.add_argument("--tiny-predictions", default="reports/vlm/symbol_tiny_p2_detector_v34_smoke_predictions.jsonl")
    parser.add_argument("--output", default="reports/vlm/symbol_proposal_eval_v34_union_smoke_cache.jsonl")
    parser.add_argument("--manifest-output", default="reports/vlm/symbol_proposal_eval_v34_union_smoke_cache_manifest.json")
    ...
    merged = merge_sources(
        ...
        ("tiny_p2_v34", load_preds(Path(args.tiny_predictions))),
    )
    ...
    out_manifest = {
        "version": "symbol_proposal_eval_v34_union_cache",
        "metric_mode": "smoke",
        "claim_boundary": "Union cache for v28 mask, v30 center branch, and v34 pixel-level tiny detector. Gold matching fields are audit/evaluation only.",
        "inputs": {
